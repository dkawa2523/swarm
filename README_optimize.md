...
- すべての `outputs/*/eedf_table.csv` を処理:  
  `python3 EEDF_optimze.py --root outputs --config EEDF_optimize.yaml`
- 特定ファイルのみ:  
  `python3 EEDF_optimze.py --table outputs/ar_n2_en_scan/eedf_table.csv --config EEDF_optimize.yaml`
- 上限分布数や試行回数を上書き:  
  `python3 EEDF_optimze.py --table ... --max-components 2 --num-starts 2`
