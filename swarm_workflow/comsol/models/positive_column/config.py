...
from ...runtime import ComsolRunContext
...
def comsol_run_context(mapping: ComsolModelMapping) -> ComsolRunContext:
    """Adapt a positive-column mapping to the model-independent runtime."""
    ...
    *,
    ...
    if data.get("schema_version") != 2:
        raise ComsolMappingError(
            "positive-column COMSOL mappings require schema_version: 2"
        )
    allowed = {
        "schema_version",
        "model",
